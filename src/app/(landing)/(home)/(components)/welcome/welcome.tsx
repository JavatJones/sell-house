    ...
    <section id='quote-now' className='relative w-full flex items-center justify-center min-h-screen xl:min-h-[500px] pt-28 lg:pt-36 px-5 '>
      ...
      <article className='container mx-auto flex flex-col lg:flex-row w-full h-full gap-10 '>
        ...
        <div className='relative flex flex-col w-full lg:w-7/12 items-center justify-center'>
          ...
          <article className='w-full lg:max-w-xl bg-white space-y-8 p-10 border-[1.8px] border-emerald-400/40 rounded-3xl drop-shadow-2xl drop-shadow-emerald-600/50'>
